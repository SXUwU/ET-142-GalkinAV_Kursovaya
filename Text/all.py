...
print(f"Количество spam: {file["Spam/Ham"].value_counts()["spam"]}. Доля от общего количества: {file["Spam/Ham"].value_counts()["spam"]/33716}")
print(f"Количество ham: {file["Spam/Ham"].value_counts()["ham"]}. Доля от общего количества: {file["Spam/Ham"].value_counts()["ham"]/33716}")
